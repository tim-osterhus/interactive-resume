# ExampleProject Golden Dataset Workflow

**Complete backup/restore/validation workflow for ExampleProject's 98-document golden dataset**

---

## Overview

ExampleProject maintains a **golden dataset** of 98 curated technical documents with embeddings for testing retrieval quality. This dataset is the source of truth for:
...
**Key Files:**
- **Backup Script:** `/path/to/project/backend/scripts/backup_golden_dataset.py`
- **JSON Backup:** `/path/to/project/backend/data/golden_dataset_backup.json` (version controlled)
- **Metadata:** `/path/to/project/backend/data/golden_dataset_metadata.json` (quick stats)
- **Fixtures:** `/path/to/project/backend/tests/smoke/retrieval/fixtures/` (source documents, queries)
...
#    Location:  /path/to/project/backend/data/golden_dataset_backup.json
# ============================================================
```
...
# BACKUP VERIFICATION
# ============================================================
#    File: /path/to/project/backend/data/golden_dataset_backup.json
...
```bash
# Restore output:
# Loaded backup from: /path/to/project/backend/data/golden_dataset_backup.json
# Backup version: 2.0
...
```bash
cd /path/to/project/backend/tests/smoke/retrieval/fixtures
...
**File:** `/path/to/project/.github/workflows/backup-golden-dataset.yml`
...
**Scenario: Fresh MacBook, setting up ExampleProject for first time**
...
# Should have: OPENAI_API_KEY=<OPENAI_API_KEY>
...
# 91.6% is the BASELINE pass rate for ExampleProject golden dataset.
