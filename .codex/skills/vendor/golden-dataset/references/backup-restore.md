...
**ExampleProject uses JSON (version controlled), SQL dump for local snapshots only.**
...
- ExampleProject: `backend/scripts/backup_golden_dataset.py`
- ExampleProject: `backend/data/golden_dataset_backup.json`
